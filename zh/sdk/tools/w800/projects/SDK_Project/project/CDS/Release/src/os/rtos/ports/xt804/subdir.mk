...
C_SRCS += \
D:/work-document/Seafile/20200606/1_SDK/wm_sdk_w800_20200605/src/os/rtos/ports/xt804/port.c 

S_UPPER_SRCS += \
D:/work-document/Seafile/20200606/1_SDK/wm_sdk_w800_20200605/src/os/rtos/ports/xt804/cpu_task_sw.S 

OBJS += \
./src/os/rtos/ports/xt804/cpu_task_sw.o \
./src/os/rtos/ports/xt804/port.o 

C_DEPS += \
./src/os/rtos/ports/xt804/port.d 

S_UPPER_DEPS += \
./src/os/rtos/ports/xt804/cpu_task_sw.d 


# Each subdirectory must supply rules for building sources it contributes
src/os/rtos/ports/xt804/cpu_task_sw.o: D:/work-document/Seafile/20200606/1_SDK/wm_sdk_w800_20200605/src/os/rtos/ports/xt804/cpu_task_sw.S
	@echo 'Building file: $<'
	@csky-elfabiv2-gcc -mcpu=ck804ef -c -mhard-float -I../../../../../../../src/os/rtos/include/ -I../../../../../../../include/arch/xt804 -Wa,--gdwarf2 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
src/os/rtos/ports/xt804/port.o: D:/work-document/Seafile/20200606/1_SDK/wm_sdk_w800_20200605/src/os/rtos/ports/xt804/port.c
	@echo 'Building file: $<'
