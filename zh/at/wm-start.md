...
![](../.assets/at/wm-start/softap1.png) 

（12） SLIST命令 查询 SoftAP 连接的 STA 信息

AT+SLIST   串口调试助手打印出连接信息

![image-20200606110935229](../.assets/at/wm-start/softap2.png) 

（13） APLKSTT    查看当前 SoftAP 状态、

  AT+APLKSTT  

![image-20200606150343683](../.assets/at/wm-start/softap3.png) 
...
![image-20200606142414198](../.assets/at/wm-start/ap1.png) 
...
![image-20200606142536748](../.assets/at/wm-start/ap2.png)    
...
![image-20200606142821415](../.assets/at/wm-start/ap3.png) 
...
![image-20200606160037309](../.assets/at/wm-start/spsta1.png)
...
![image-20200606160306099](../.assets/at/wm-start/spsta2.png) 
...
![image-20200606160416070](../.assets/at/wm-start/spsta3.png) 
...
![image-20200606160711304](../.assets/at/wm-start/spsta4.png) 
...
![image-20200606160756851](../.assets/at/wm-start/spsta5.png) 
...
![image-20200606183042023](../.assets/at/wm-start/socket_1.png)
...
![image-20200606160037309](../.assets/at/wm-start/socket_2.png)
...
![image-20200606160306099](../.assets/at/wm-start/socket_3.png) 
...
![image-20200606160416070](../.assets/at/wm-start/socket_4.png) 
...
![image-20200606160711304](../.assets/at/wm-start/socket_5.png) 
...
![image-20200606160756851](../.assets/at/wm-start/socket_6.png) 
...
![image-20200606165502253](../.assets/at/wm-start/socket_7.png) 

​                                                       返回SOCKET号：1

![image-20200606165603391](../.assets/at/wm-start/socket_8.png)  
...
![image-20200606165823176](../.assets/at/wm-start/socket_9.png)

​     指令发送之后打印出如上命令则为**串口出错**，需要外接其他串口，此处使用的是串口1，默认的使用的是串口0，使用TTL转串口

![image-20200606180545113](../.assets/at/wm-start/socket_10.png)

此处为发送指令成功的打印信息。注意此处要选取相宜的发送字符数，否则会一直等待字符数相等时传输过去。发送字符串 “hello thingsturn”![image-20200606182106888](../.assets/at/wm-start/socket_11.png)
...
![image-20200606181513961](../.assets/at/wm-start/socket_12.png) 

​                                                              net assist 发送字符

![image-20200606181624712](../.assets/at/wm-start/socket_13.png) 
...
![image-20200608101223547](../.assets/at/wm-start/btnet1.png) 

4.1.2AT+ONESHOT=4 //开启蓝牙配网服务
此时可以用 APP（**WMBleWiFi**）进行配网操作；注意配网成功后，系统会自动注销配网服务。

<img src="../.assets/at/wm-start/btnet2.png" alt="image-20200608102729662" style="zoom: 50%;" /> 

​                                        选择为WM开头的蓝牙名称

<img src="../.assets/at/wm-start/btnet3.png" alt="image-20200608102825495" style="zoom:50%;" /> 
...
![image-20200608133809805](../.assets/at/wm-start/btconnect1.png) 
...
![image-20200608134156755](../.assets/at/wm-start/btconnect2.png) 
...
![image-20200608134229188](../.assets/at/wm-start/btconnect3.png) 
...
![image-20200608134309061](../.assets/at/wm-start/btconnect4.png) 
...
![image-20200608134501275](../.assets/at/wm-start/btconnect5.png) 
...
![image-20200608135019046](../.assets/at/wm-start/btconnect6.png) 
...
![image-20200608134645891](../.assets/at/wm-start/btconnect7.png) 
...
*参数 2 ：data： 广播内容， 该内容将以 FF 字段 paylaod 广播，为 HEX 格式。例如，设置广播数据为 0x11 0x22 0x33  0x44 0x55，则设置指令为： AT+BLEADVDATA=1122334455。*
 ...
 <img src="../.assets/at/wm-start/btconnect8.png" alt="image-20200608135044233" style="zoom:50%;" /> 
...
<img src="../.assets/at/wm-start/btconnect9.png" alt="image-20200608141530811" style="zoom:50%;" /> 

  ( 9 ）手机侧发起连接
点击 CONNECT 按钮，此时 w800 会显示：   ![image-20200608141914567](../.assets/at/wm-start/btconnect10.png)

即手机的 MAC 地址 578AECE2D226 连接成功。连接成功后，手机侧可以看到我
们创建的服务描述。
下图中， 1826 即为我们创建的服务  

<img src="../.assets/at/wm-start/btconnect11.png" alt="image-20200608142037918" style="zoom:50%;" /> 

单击 Transport Discovery 即可看到我们创建的特性值及描述  

<img src="../.assets/at/wm-start/btconnect12.png" alt="image-20200608142321634" style="zoom:50%;" /> 

 ( 10 ）手机侧使能 Indication 功能
点击 0x2abc 右侧的上下箭头，代表使能 indicate 操作，此后， W800 会每隔 2S 发
送字符串给手机，显示如下： BLE， 当前系统时间，下面显示的 HEX 格式  

![image-20200608142504829](../.assets/at/wm-start/btconnect13.png) 

​                                          串口打印出手机已经接收的信息

<img src="../.assets/at/wm-start/btconnect14.png" alt="image-20200608142836226" style="zoom:50%;" /> 
...
<img src="../.assets/at/wm-start/btconnect15.png" alt="image-20200608144146272" style="zoom:50%;" /> 

APP 显示收到的返回值：  

<img src="../.assets/at/wm-start/btconnect16.png" alt="image-20200608144232483" style="zoom:50%;" /> 

此时 W800 侧会显示收到的内容：  

![image-20200608144104238](../.assets/at/wm-start/btconnect17.png) 

 ( 12 ）手机侧读取描述符
点击描述符右侧的读操作，向下的箭头，代表读取描述内容  

<img src="../.assets/at/wm-start/btconnect18.png" alt="image-20200608144731851" style="zoom:50%;" />      
...
![ ](../.assets/at/wm-start/btconnect19.png)  

 ( 14 ）删除服务
AT+BLEDELSC=4,40  

![image-20200608145750365](../.assets/at/wm-start/btconnect20.png) 

 ( 15 ）注销 server
AT+BLEDESSV=4 //注销 client_if 为 4 的 server  

![image-20200608145820579](../.assets/at/wm-start/btconnect21.png) 

 ( 16 ）注销蓝牙服务
AT+BTDES  

![image-20200608145854859](../.assets/at/wm-start/btconnect22.png) 
